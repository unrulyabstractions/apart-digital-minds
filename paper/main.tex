...
a rerun reproduces the reported values. The supplementary material carries every
scenario, every probe and the full result of each study, written from the same
sources. The subject models are open-weight
...
involved. The supplementary material reports every scenario in full, so a reader
who disagrees can see exactly what was done.
